...
if($_POST){
 ...
 function inserisci_record()
 {
   ...
   //recupero i campi di tipo stringa per Atleta
	...
	$query0=mysql_query("SELECT Atleta.id FROM Atleta WHERE Atleta.nome='$nomeA' AND Atleta.cognome='$cognomeA'");
	$query1="DELETE FROM Atleta WHERE Atleta.nome='$nomeA' AND Atleta.cognome='$cognomeA'";
